...
| `--vpat` | Draft VPAT®/ACR conformance report (`<page>-vpat.md` + PDF + `.json`), plus a conformance trend + history | off |
| `--fail-on-regression` | CI gate (exit 2) when conformance drops vs the previous run; implies `--vpat` | off |
